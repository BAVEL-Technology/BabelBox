...
<body class="h-screen">
		...
		<Header bind:showAPIDocs={showAPIDocs} currentUser={currentUser} dataTables={dataTables} bind:activeTable={activeTable} bind:headers={headers} fetchData={fetchData} bind:displayedData={displayedData}/>
